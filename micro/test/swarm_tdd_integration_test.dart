/// TDD Integration Tests for Swarm Intelligence
...
[
  ...
  },
  {
    ...
    "priority": 0.8
        ...
        // At least one specialist should have succeeded
  ...
  "implementation_order": ["UI fixes", "Memory fixes", "Startup optimization"]
    ...
    group('Swarm Behavior Edge Cases', () {
      test('TDD: Handle empty specialist generation', () async {
        ...
        // Mock LLM returning empty specialists
        when(() => mockLanguageModel.invoke(any())).thenReturn('[]');
